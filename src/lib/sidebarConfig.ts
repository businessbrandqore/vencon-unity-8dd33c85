...
export const sidebarMenus: Record<PanelType, SidebarItem[]> = {
  ...
  tl: [
    ...
    { titleKey: "data_tracker", icon: BarChart3, path: "/tl/data-tracker", roles: ["team_leader", "assistant_team_leader", "Business Development And Marketing Manager"] },
    { titleKey: "data_requests", icon: Database, path: "/tl/data-requests", roles: ["team_leader", "assistant_team_leader", "Business Development And Marketing Manager"] },
    { titleKey: "my_team", icon: UserCheck, path: "/tl/my-team", roles: ["team_leader", "assistant_team_leader", "Business Development And Marketing Manager"] },
    { titleKey: "analytics", icon: BarChart3, path: "/tl/analytics", roles: ["team_leader", "assistant_team_leader", "Business Development And Marketing Manager"] },
  ...
  employee: [
    ...
    { titleKey: "leads", icon: Target, path: "/employee/leads", roles: ["telesales_executive"] },
    { titleKey: "my_orders", icon: Package, path: "/employee/my-orders", roles: ["telesales_executive"] },
