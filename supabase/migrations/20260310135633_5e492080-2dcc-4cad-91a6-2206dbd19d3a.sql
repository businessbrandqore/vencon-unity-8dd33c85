...
-- Complete salary calculation function
...
BEGIN
  ...
  ELSE
    ...
    -- Calculate total incentive pool for all incentive roles
    -- We sum up individual incentives calculated for each incentive-based user
